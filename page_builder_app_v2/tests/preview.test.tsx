...
describe("buildPreview", () => {
  ...
  test("wraps exactly the exported fragment in the generated shell", async () => {
    ...
    // Preview and export no longer produce the same bytes: export writes a body
    ...
    // nav.njk/footer.njk). The invariant that matters is that the preview
    // contains the exported body verbatim, so what you see is what is published.
