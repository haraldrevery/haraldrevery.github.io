...
(function (global) {
  ...
  function init() {
    ...
    els.txt.addEventListener("click", () => { if (haveArt()) RVRY.ui.exportTxt(state.lastText, "rvry-image"); });
    els.md.addEventListener("click", () => { if (haveArt()) RVRY.ui.exportMd(state.lastText, "rvry-image"); });
