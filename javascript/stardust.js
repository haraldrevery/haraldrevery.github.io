/* Performance constants */
        ...
        modeToggle.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                if (window.bgPlexus) window.bgPlexus.restart();
            }, 50);
        });
        ...
        window.restartPlexus = function() {
            ...
            const targetParticleCount = isMobile ? 96 : 610;
        ...
        class BackgroundPlexus {
            ...
            // Restart method - clears particles and resets timing
            restart() {
                this.particles = [];
                this.startTime = Date.now();
        ...
        function setupAutoRestart() {
            setInterval(() => {
                console.log('[Plexus] Auto-restart triggered (4 hours)');
                
                // Restart background plexus
                if (window.bgPlexus) {
                    window.bgPlexus.restart();
                }
                
                // Restart logo plexus
                if (window.restartPlexus) {
                    restartPlexus();
                }
                
                // Restart logo animations
                if (window.restartLogoAnimations) {
