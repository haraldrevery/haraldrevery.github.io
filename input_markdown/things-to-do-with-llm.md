---
title: Things to do with LLM
date: 2026-08-28
image: /notebook_thumbnails/some_text_just_works_min.jpg
tags: [thoughts]
description: Things to do with "AI" (LLM) that are useful before the bubble bursts, regulations hit or gets too expensive. 
---


# Things to do with LLM

Lately, I have been experimenting a lot with Large Language Model (LLM), despite me being very hesitant to using AI tools for various reasons, I do find it very useful for certain tasks, one being to generate code (specifically HTML, JavaScript and Python), some mixed results with Rust and C++, but here some cool projects to do while the "AI" hype is carrying most of the computational costs. Maybe models gets better and cheaper or it will be regulated, expensive, hitting the data wall or the limit of just token prediction algorithms can do leading to another "AI winter". Anyway, consider these projects until then, the current model performances are pretty good for these types of projects.
...
In contrast of having a static website that is your digital presence, I think it's also important to bring what is digital to real world. In the last decades there has been a push to store everything digital, despite its technology being really fragile (HDD's, SSD's and CD's can barely store something reliably for 10 years...). As humans, it's really dangerous to rely on storing information in a format that requires advanced electronics and logic to extract information. Paper has proven to be the most durable and cost effective medium. Books are simply battle tested and has stood the test of time for storing information. Just keep it away from fire and water, it will lasts for ~100 years (assume quality ink to guarantee easy readability) and you only need light and reading skills to extract information from the medium. 


Having a printer and some nice *print ready* templates to take what ever you have to the physical paper seems like a good thing to have, LLM's can help you automate this for your personal texts.
...
-  Screen savers / wall paper loops: If you got a logo or something for a brand, make some self container webpages with interesting visuals. See it as a sibling project to the OBS Studio streaming layout or if you have a branding project and you need some background visuals (TV billboards or background in a video etc).
